...
$(document).ready(function() { //jQuery cuando el documento esté listo, ejecutar función
   $("button").click(function() { // cuando haga click sobre el botón, ejecutar función calculate
     calculate();
   });
 });
